...
void _port_switch(thread_t *ntp, thread_t *otp) {
  ...
  // ? This code seems to use only lower r30 register to setup Z register using r22 and r24 to switch stack pointer
  ...
  // Load Z low register from r24 and load SP from there always using r0 register to support this transfer
